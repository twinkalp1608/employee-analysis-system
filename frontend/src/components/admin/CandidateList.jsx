...
const CandidateList = () => {
  ...
  const fetchCandidates = async () => {
    try {
      ...
      const res = await axios.get("${import.meta.env.VITE_API_URL}/api/hr/candidates", {
  ...
  const updateStatus = async (id, status) => {
    try {
      ...
      const res = await axios.put(
        `${import.meta.env.VITE_API_URL}/api/hr/candidates/${id}/status`,
        { status },
        { headers: { Authorization: `Bearer ${token}` } },
      );
                  ...
                  <td>
                    {candidate.resume ? (
                      <div className="recruitment-actions">
                        <a
                          href={`${import.meta.env.VITE_API_URL}/api/download-resume/${candidate.resume.split("/").pop()}`}
