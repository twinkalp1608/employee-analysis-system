...
const PayrollList = () => {
  ...
  const fetchPayrolls = async () => {
    try {
      ...
      const res = await axios.get("http://https://employee-analysis-system-1.onrender.com//api/admin/payroll", {
        headers: {
  ...
  const approvePayroll = async (id) => {
    try {
      ...
      await axios.put(
        `http://https://employee-analysis-system-1.onrender.com//api/admin/payroll/${id}/approve`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const rejectPayroll = async (id) => {
    try {
      ...
      await axios.put(
        `http://https://employee-analysis-system-1.onrender.com//api/admin/payroll/${id}/reject`,
        { rejectionReason },
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handlePayNow = async (payroll) => {
    try {
      ...
      const { data } = await axios.post(
        `http://https://employee-analysis-system-1.onrender.com//api/admin/payroll/${payroll._id}/create-order`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      const options = {
        ...
        handler: async function (response) {
          await axios.post(
            "http://https://employee-analysis-system-1.onrender.com//api/admin/payroll/verify-payment",
            {
