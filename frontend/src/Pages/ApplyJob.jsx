...
export default function ApplyJob() {
  ...
  const fetchJobDetails = async () => {
    try {
      const res = await axios.get(`http://https://employee-analysis-system-1.onrender.com//api/jobs/${jobId}`);
      setJob(res.data.job);
    } catch (error) {
      console.log(error);
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "http://https://employee-analysis-system-1.onrender.com//api/candidates/apply",
        form
      );
